...
def process_excel_data(input_file, output_file):
    ...
    # 设置目标域
    average_results['TargetDomain'] = 'OD05'
    max_averages_df['TargetDomain'] = 'OD05'
...
if __name__ == "__main__":
    ...
    output_excel = '/IMBR_Data/Student-home/2023M_ShiGuangze/code/SwinTV2_UNet/SwinTV2UNet_bak/Fundus256/result_1e-3_9e-1_small16/05/results_OD.xlsx'
    input_excel_file = output_excel  # Assuming you want to process the same file
    output_excel_file = '/IMBR_Data/Student-home/2023M_ShiGuangze/code/SwinTV2_UNet/SwinTV2UNet_bak/Fundus256/result_1e-3_9e-1_small16/05/mean_OD.xlsx'
